...
<div>
<input class="custom-btn btn-1" type="submit" value="<spring:message code="Editpersonalinformation"/>"><br>
<button type="button"  class="custom-btn1 btn-2" onclick="location.href='mypage' ">마이페이지 이동</button>
</div>
</form>
</c:if>
<c:if test="${dis}">
